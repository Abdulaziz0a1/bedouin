        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            <div
              ...
              style={{ background: "linear-gradient(90deg, transparent, rgba(196,154,79,0.5))" }}
            />
            ...
            <div
              className="h-px flex-1 max-w-[3rem]"
              style={{ background: "linear-gradient(90deg, rgba(196,154,79,0.5), transparent)" }}
            />
          </div>
