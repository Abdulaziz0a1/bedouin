...
export default function ResetPasswordForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Show the success state briefly, then sign the user out so they must
    // confirm the new password works by logging in fresh.
    setSuccess(true);
    ...
    return (
      <div className="flex flex-col items-center text-center gap-3 py-4">
        <div
          ...
          style={{ background: "#f0faf5", color: "#049153" }}
        >
        ...
        <div className="mt-2">
          <svg className="animate-spin w-5 h-5 text-[#c49a4f] mx-auto" viewBox="0 0 24 24" fill="none">
